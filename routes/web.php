...
Carbon::setTestNow(now()->addDay(4)->setTimeFromTimeString('08:00:00'));
...
Route::delete('/appointments/{appointment:id}', AppointmentDestroyController::class)->name('appointments.destroy');
